...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters eval15/train
        parser.add_argument('--dataroot',  default=r'./',help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='EC_gan')
        parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in the last conv layer')
        parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in the first conv layer')
        parser.add_argument('--nuf', type=int, default=4, help='# of discrim filters in the first conv layer')
        parser.add_argument('--Unet', type=str, default='unet_128',help=' the layers in the Unet')
        ...
        parser.add_argument('--netG', type=str, default='G_A', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        ...
        parser.add_argument('--load_size', type=int, default=1480, help='scale images to this size')
        parser.add_argument('--crop_size', type=int, default=1480, help='then crop to this size')
