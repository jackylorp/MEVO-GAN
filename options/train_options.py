...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_env', type=str, default='main2', help='visdom display environment name (default is "main")')
        ...
        parser.add_argument('--epoch_count', type=int, default=701, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, ...')
        ...
        parser.add_argument('--cat_num', type=int, default=3, help='# of categories of conditional generation')
